  ...
  _createClass(ReactCreditCards, [{
    ...
    value: function componentDidMount() {
      ...
      if (formatNumber && numberInputName) {
        _payment2.default.formatCardNumber(document.querySelector('[name="' + numberInputName + '"]'));
      }
     ...
     */
    value: function setCardType(type) {
      var _this2 = this;

      var acceptedCards = _payment2.default.getCardArray() || [];

      acceptedCards.every(function (card) {
        if (card && card.type === type) {
          var typeState = {
            issuer: type,
            maxLength: _this2.state.type.maxLength
          };
    ...
    value: function updateType(number) {
      ...
      var cardInfo = _payment2.default.fns.cardInfo(number) || {};
...
ReactCreditCards.propTypes = {
  ...
  formatNumber: _propTypes2.default.bool,
  numberInputName: _propTypes2.default.string
};
